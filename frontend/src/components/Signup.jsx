...
const Signup = () => {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-br from-blue-400/30 via-blue-100/30 to-white/40" />
      <div className="relative z-10 bg-white/90 border border-slate-300 p-8 rounded-xl shadow-2xl w-96 transform transition-all duration-500 hover:scale-105 hover:shadow-2xl animate-fadeIn">

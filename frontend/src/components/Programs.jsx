          ...
          >
            ...
            >
              ...
              <button
                ...
                className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-semibold transition-all duration-200 self-start shadow-lg hover:shadow-blue-500/50 hover:scale-105 relative z-10"
              >
                Learn More
              </button>
            </div>

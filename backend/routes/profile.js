...
// -------------------------------
// The account deletion endpoint has been removed to prevent accidental self-deletion via the public API.
// If account removal is required in the future, reintroduce a well-audited admin-only endpoint.
